...
{
    public abstract class DirectoryTiffHandler(List<Directory> directories) : ITiffHandler
    {
        private readonly Stack<Directory> _directoryStack = new();

        protected List<Directory> Directories { get; } = directories;
...
#pragma warning restore format
        ...
        public abstract Task<bool> CustomProcessTagAsync(TiffReaderContext context, int tagId, int valueOffset, int byteCount);
