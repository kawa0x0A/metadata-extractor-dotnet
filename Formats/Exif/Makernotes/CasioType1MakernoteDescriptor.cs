...
{
    public sealed class CasioType1MakernoteDescriptor(CasioType1MakernoteDirectory directory) : TagDescriptor<CasioType1MakernoteDirectory>(directory)
    {
        ...
        {
            if (!Directory.TryGetInt(CasioType1MakernoteDirectory.TagCcdSensitivity, out int value))
                return null;
            return value switch
            {
                64 => "Normal",
        ...
        {
            if (!Directory.TryGetInt(CasioType1MakernoteDirectory.TagDigitalZoom, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CasioType1MakernoteDirectory.TagWhiteBalance, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CasioType1MakernoteDirectory.TagObjectDistance, out int value))
                return null;
            return value + " mm";
        }
        ...
        {
            if (!Directory.TryGetInt(CasioType1MakernoteDirectory.TagFlashIntensity, out int value))
                return null;
