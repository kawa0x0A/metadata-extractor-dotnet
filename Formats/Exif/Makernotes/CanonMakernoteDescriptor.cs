...
{
    public sealed class CanonMakernoteDescriptor(CanonMakernoteDirectory directory) : TagDescriptor<CanonMakernoteDirectory>(directory)
    {
        ...
        {
            return Directory.TryGetInt(CanonMakernoteDirectory.TagCanonSerialNumber, out int value)
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.FocalLength.TagFlashBias, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.FocalLength.TagAfPointUsed, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetShort(CanonMakernoteDirectory.AfInfo.TagAfPointsInFocus, out short value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagFlashDetails, out int value))
                return null;
...
#pragma warning restore format
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagFocalUnitsPerMm, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagShortFocalLength, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagLongFocalLength, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagIso, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagSharpness, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagSaturation, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagContrast, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagContinuousDriveMode, out int value))
                return null;

            switch (value)
            {
                case 0:
                    if (Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagSelfTimerDelay, out int delay))
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagFlashMode, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagSelfTimerDelay, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagQuality, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagFocusType, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagLensType, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagMaxAperture, out int value))
                return null;
            if (value > 512)
                return $"Unknown ({value})";
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagMinAperture, out int value))
                return null;
            if (value > 512)
                return $"Unknown ({value})";
            return GetFStopDescription(Math.Exp(DecodeCanonEv(value) * Math.Log(2.0) / 2.0));
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagDisplayAperture, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagPhotoEffect, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagManualFlashOutput, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CanonMakernoteDirectory.CameraSettings.TagColorTone, out int value))
                return null;
