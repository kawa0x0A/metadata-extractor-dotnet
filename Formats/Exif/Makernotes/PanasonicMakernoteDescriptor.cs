...
{
    public sealed class PanasonicMakernoteDescriptor(PanasonicMakernoteDirectory directory) : TagDescriptor<PanasonicMakernoteDirectory>(directory)
    {
        ...
        {
            var bytes = Directory.GetArray<byte[]>(PanasonicMakernoteDirectory.TagLensFirmwareVersion);
            if (bytes is null)
                return null;
        ...
        {
            if (!Directory.TryGetInt(PanasonicMakernoteDirectory.TagAccelerometerZ, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(PanasonicMakernoteDirectory.TagAccelerometerX, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(PanasonicMakernoteDirectory.TagAccelerometerY, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(PanasonicMakernoteDirectory.TagRollAngle, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(PanasonicMakernoteDirectory.TagPitchAngle, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetUshort(PanasonicMakernoteDirectory.TagHdr, out ushort value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(PanasonicMakernoteDirectory.TagUptime, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(PanasonicMakernoteDirectory.TagContrastMode, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(PanasonicMakernoteDirectory.TagRotation, out int value))
                return null;
        ...
        {
            var value = Directory.GetArray<int[]>(PanasonicMakernoteDirectory.TagAfAreaMode);
