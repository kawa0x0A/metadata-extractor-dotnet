...
{
    public sealed class CasioType2MakernoteDescriptor(CasioType2MakernoteDirectory directory) : TagDescriptor<CasioType2MakernoteDirectory>(directory)
    {
        ...
        {
            if (!Directory.TryGetInt(CasioType2MakernoteDirectory.TagFocusMode2, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CasioType2MakernoteDirectory.TagObjectDistance, out int value))
                return null;
            return value + " mm";
        }
        ...
        {
            if (!Directory.TryGetInt(CasioType2MakernoteDirectory.TagWhiteBalance2, out int value))
                return null;
            return value switch
            {
                0 => "Manual",
        ...
        {
            var bytes = Directory.GetArray<byte[]>(CasioType2MakernoteDirectory.TagPreviewThumbnail);
            if (bytes is null)
                return null;
        ...
        {
            if (!Directory.TryGetInt(CasioType2MakernoteDirectory.TagIsoSensitivity, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CasioType2MakernoteDirectory.TagImageSize, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(CasioType2MakernoteDirectory.TagThumbnailSize, out int value))
                return null;
        ...
        {
            var dimensions = Directory.GetArray<int[]>(CasioType2MakernoteDirectory.TagThumbnailDimensions);
