...
{
    public class SamsungType2MakernoteDescriptor(SamsungType2MakernoteDirectory directory) : TagDescriptor<SamsungType2MakernoteDirectory>(directory)
    {
        ...
        {
            if (!Directory.TryGetUint(TagDeviceType, out uint value))
                return null;
        ...
        {
            if (!Directory.TryGetUint(TagSamsungModelId, out uint value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(TagRawDataCfaPattern, out int value))
                return null;
