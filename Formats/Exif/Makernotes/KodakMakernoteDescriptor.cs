...
{
    public sealed class KodakMakernoteDescriptor(KodakMakernoteDirectory directory) : TagDescriptor<KodakMakernoteDirectory>(directory)
    {
        ...
        {
            if (!Directory.TryGetInt(KodakMakernoteDirectory.TagColorMode, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(KodakMakernoteDirectory.TagFlashMode, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(KodakMakernoteDirectory.TagShutterMode, out int value))
                return null;
