...
{
    public sealed class OlympusCameraSettingsMakernoteDescriptor(OlympusCameraSettingsMakernoteDirectory directory) : TagDescriptor<OlympusCameraSettingsMakernoteDirectory>(directory)
    {
        ...
        {
            if (!Directory.TryGetInt(OlympusCameraSettingsMakernoteDirectory.TagMeteringMode, out int value))
                return null;
        ...
        {
            var values = Directory.GetArray<ushort[]>(OlympusCameraSettingsMakernoteDirectory.TagFocusMode);

            if (values is null)
            {
                if (!Directory.TryGetInt(OlympusCameraSettingsMakernoteDirectory.TagFocusMode, out int value))
                    return null;
...
#pragma warning restore format
        ...
        {
            var values = Directory.GetArray<ushort[]>(OlympusCameraSettingsMakernoteDirectory.TagFocusProcess);

            if (values is null)
            {
                if (!Directory.TryGetInt(OlympusCameraSettingsMakernoteDirectory.TagFocusProcess, out int value))
                    return null;
        ...
        {
            var points = Directory.GetArray<uint[]>(OlympusCameraSettingsMakernoteDirectory.TagAfAreas);
        ...
        {
            var vals = Directory.GetArray<Rational[]>(OlympusCameraSettingsMakernoteDirectory.TagAfPointSelected);
...
#pragma warning restore format
        ...
        {
            if (!Directory.TryGetInt(OlympusCameraSettingsMakernoteDirectory.TagFlashMode, out int value))
                return null;
...
#pragma warning restore format
        ...
        {
            if (!Directory.TryGetInt(OlympusCameraSettingsMakernoteDirectory.TagFlashRemoteControl, out int value))
                return null;
        ...
        {
            var values = Directory.GetArray<ushort[]>(OlympusCameraSettingsMakernoteDirectory.TagFlashControlMode);
        ...
        {
            var vals = Directory.GetArray<Rational[]>(OlympusCameraSettingsMakernoteDirectory.TagFlashIntensity);
        ...
        {
            var vals = Directory.GetArray<Rational[]>(OlympusCameraSettingsMakernoteDirectory.TagManualFlashStrength);
        ...
        {
            if (!Directory.TryGetInt(OlympusCameraSettingsMakernoteDirectory.TagWhiteBalance2, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(OlympusCameraSettingsMakernoteDirectory.TagWhiteBalanceTemperature, out int value))
                return null;
            if (value == 0)
                return "Auto";
        ...
        {
            if (!Directory.TryGetInt(OlympusCameraSettingsMakernoteDirectory.TagSceneMode, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(OlympusCameraSettingsMakernoteDirectory.TagNoiseReduction, out int value))
                return null;
        ...
        {
            var values = Directory.GetArray<short[]>(OlympusCameraSettingsMakernoteDirectory.TagGradation);
        ...
        {
            var values = Directory.GetArray<ushort[]>(OlympusCameraSettingsMakernoteDirectory.TagPictureMode);
            if (values is null)
            {
                // check if it's only one value long also
                if (!Directory.TryGetInt(OlympusCameraSettingsMakernoteDirectory.TagPictureMode, out int value))
                    return null;
        ...
        {
            var values = Directory.GetArray<short[]>(OlympusCameraSettingsMakernoteDirectory.TagNoiseFilter);
        ...
        {
            var values = Directory.GetArray<short[]>(OlympusCameraSettingsMakernoteDirectory.TagPictureModeEffect);
        ...
        {
            var values = Directory.GetArray<short[]>(OlympusCameraSettingsMakernoteDirectory.TagToneLevel);
        ...
        {
            var values = Directory.GetArray<ushort[]>(OlympusCameraSettingsMakernoteDirectory.TagArtFilterEffect);
        ...
        {
            var values = Directory.GetArray<short[]>(OlympusCameraSettingsMakernoteDirectory.TagColorCreatorEffect);
        ...
        {
            var values = Directory.GetArray<ushort[]>(OlympusCameraSettingsMakernoteDirectory.TagDriveMode);
...
#pragma warning restore format
        ...
        {
            var values = Directory.GetArray<ushort[]>(OlympusCameraSettingsMakernoteDirectory.TagPanoramaMode);
        ...
        {
            var values = Directory.GetArray<short[]>(OlympusCameraSettingsMakernoteDirectory.TagStackedImage);
        ...
        {
            if (!Directory.TryGetInt(OlympusCameraSettingsMakernoteDirectory.TagManometerPressure, out int value))
                return null;
        ...
        {
            var values = Directory.GetArray<int[]>(OlympusCameraSettingsMakernoteDirectory.TagManometerReading);
        ...
        {
            var values = Directory.GetArray<short[]>(OlympusCameraSettingsMakernoteDirectory.TagRollAngle);
        ...
        {
            var values = Directory.GetArray<short[]>(OlympusCameraSettingsMakernoteDirectory.TagPitchAngle);
        ...
        {
            return Directory.GetDateTime(OlympusCameraSettingsMakernoteDirectory.TagDateTimeUtc).ToString();
        }

        private string? GetValueMinMaxDescription(int tagId)
        {
            var values = Directory.GetArray<short[]>(tagId);
