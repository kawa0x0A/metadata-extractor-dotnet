namespace MetadataExtractor.Formats.Exif.Makernotes
{
    public sealed class OlympusMakernoteDirectory : Directory
    {
        ...
        public override void Set(int tagType, int value)
        {
            if ((tagType == TagCameraSettings1 || tagType == TagCameraSettings2))
                ProcessCameraSettings(value);
            else
                base.Set(tagType, value);
        }

        private void ProcessCameraSettings(int value)
        {
            Set(CameraSettings.Offset, value);
        }

        public bool IsIntervalMode()
        {
            return this.TryGetLong(CameraSettings.TagShootingMode, out long value) && value == 5;
        }
