...
{
    public sealed class OlympusRawDevelopment2MakernoteDescriptor(OlympusRawDevelopment2MakernoteDirectory directory) : TagDescriptor<OlympusRawDevelopment2MakernoteDirectory>(directory)
    {
        ...
        {
            if (!Directory.TryGetInt(OlympusRawDevelopment2MakernoteDirectory.TagRawDevNoiseReduction, out int value))
                return null;
...
#pragma warning restore format
        ...
        {
            if (!Directory.TryGetInt(OlympusRawDevelopment2MakernoteDirectory.TagRawDevPictureMode, out int value))
                return null;
