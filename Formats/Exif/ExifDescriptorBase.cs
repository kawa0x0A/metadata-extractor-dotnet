...
{
    public abstract class ExifDescriptorBase<T>(T directory) : TagDescriptor<T>(directory) where T : Directory
    {
...
#pragma warning restore format
        ...
        {
            var ints = Directory.GetArray<int[]>(TagReferenceBlackWhite);
        ...
        {
            var positions = Directory.GetArray<int[]>(TagYCbCrSubsampling);
        ...
        {
            if (!Directory.TryGetInt(TagPhotometricInterpretation, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(Tag35MMFilmEquivFocalLength, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(TagIsoEquivalent, out int value))
                return null;
        ...
        {
            var values = Directory.GetArray<byte[]>(TagCfaPattern2);
            if (values is null)
                return null;

            var repeatPattern = Directory.GetArray<ushort[]>(TagCfaRepeatPatternDim);
        ...
        private int[]? DecodeCfaPattern(int tagType)
        {
            ...
            var values = Directory.GetArray<byte[]>(tagType);
            if (values is null)
                return null;
        ...
        {
            if (!Directory.TryGetInt(TagExifImageWidth, out int value))
                return null;
            return value + " pixels";
        }
        ...
        {
            if (!Directory.TryGetInt(TagExifImageHeight, out int value))
                return null;
            return value + " pixels";
        }
        ...
        {
            if (!Directory.TryGetInt(TagColorSpace, out int value))
                return null;
            if (value == 1)
                return "sRGB";
            if (value == 65535)
        ...
        {
            if (!Directory.TryGetInt(TagFlash, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(TagWhiteBalance, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(TagMeteringMode, out int value))
                return null;
        ...
        {
            if (!Directory.TryGetInt(TagCompression, out int value))
                return null;
        ...
        {
            var components = Directory.GetArray<int[]>(TagComponentsConfiguration);
        ...
        {
            if (!Directory.TryGetInt(TagJpegProc, out int value))
                return null;
        ...
        {
            var values = Directory.GetArray<int[]>(TagSampleFormat);
