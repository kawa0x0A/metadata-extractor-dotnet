...
{
    public sealed class GeoTiffDescriptor(GeoTiffDirectory directory) : TagDescriptor<GeoTiffDirectory>(directory)
    {
...
#pragma warning restore format
        ...
        {
            if (!Directory.TryGetUshort(GeoTiffDirectory.TagModelType, out ushort value))
                return null;
        ...
        {
            if (!Directory.TryGetUshort(GeoTiffDirectory.TagRasterType, out ushort value))
                return null;
        ...
        {
            if (!Directory.TryGetUshort(GeoTiffDirectory.TagGeographicType, out ushort value))
                return null;
        ...
        {
            if (!Directory.TryGetUshort(GeoTiffDirectory.TagGeodeticDatum, out ushort value))
                return null;
        ...
        {
            if (!Directory.TryGetUshort(GeoTiffDirectory.TagGeographicEllipsoid, out ushort value))
                return null;
        ...
        {
            if (!Directory.TryGetUshort(GeoTiffDirectory.TagProjectedCSType, out ushort value))
                return null;
        ...
        {
            if (!Directory.TryGetUshort(GeoTiffDirectory.TagProjection, out ushort value))
                return null;
        ...
        {
            if (!Directory.TryGetUshort(GeoTiffDirectory.TagProjectedCoordinateTransform, out ushort value))
                return null;
        ...
        {
            if (!Directory.TryGetUshort(GeoTiffDirectory.TagChartFormat, out ushort value))
                return null;
        ...
        {
            if (!Directory.TryGetUshort(GeoTiffDirectory.TagChartSoundingDatum, out ushort value))
                return null;
